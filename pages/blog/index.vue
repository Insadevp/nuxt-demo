...
export default {
  ...
  async asyncData ({ $prismic, params, error }) {
    ...
    /*
      - Récupérer la localisation sur le device de l'utilisateur
      - Accès à une API pour récupérer les stations proches de toi
      - Comparer les données et selectionner les bonnes selon des critères
      - Afficher une map avec un curseur poru chaque station
    */
